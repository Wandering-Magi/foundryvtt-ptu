...
Before installing this system, you should rename any files that have `ptu` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `ptu` and `Boilerplate` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3Boilerplate System](https://gitlab.com/asacolips-projects/foundry-mods/vue3ptu) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/ptu.png)
